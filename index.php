	...
	<head>
		...
		<link rel="stylesheet" href="\wp-content\themes\science_lab-6\style.css">
	...
	<body>
		...
		<div class="site-content">
				...
				<div class="container">
					<div class="header-bar">
						<a href="index.html" class="branding">
							...
							<div class="logo-type">
								<h1 class="site-title">AUT IOT LAB</h1>
						...
						<nav class="main-navigation">
							...
							<ul class="menu">
								<li class="home menu-item current-menu-item"><a href="/"><img src="images/home-icon.png" alt="Home"></a></li>
								<li class="menu-item"><a href="/wp-content/themes/science_lab-6/about.html">About</a></li>
								<li class="menu-item"><a href="/wp-content/themes/science_lab-6/services.html">Services</a></li>
								<li class="menu-item"><a href="/wp-content/themes/science_lab-6/projects.html">Our projects</a></li>
								<li class="menu-item"><a href="/wp-content/themes/science_lab-6/contact.html">Contact</a></li>
							</ul>
						</nav>
			...
			<div class="hero">
				<ul class="slides">
					<li data-bg-image="/wp-content/themes/science_lab-6/images/slider-1.jpg">
						<div class="container">
							<div class="slide-content">
								<h2 class="slide-title">Amirkabir University of Technology</h2>
								<h4 class="slide-title">Internet of Things Lab</h4>							
							</div>
						</div>
					</li>
					<li data-bg-image="/wp-content/themes/science_lab-6/images/slider-2.jpg">
						<div class="container">
							<div class="slide-content">
							<h2 class="slide-title">Amirkabir University of Technology</h2>
								<h4 class="slide-title">Internet of Things Lab</h4>	
					...
					<li data-bg-image="/wp-content/themes/science_lab-6/images/slider-3.jpg">
						<div class="container">
							<div class="slide-content">
								<h2 class="slide-title">Amirkabir University of Technology</h2>
								<h4 class="slide-title">Internet of Things Lab</h4>	
			...
			<main class="main-content">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-3 col-sm-6">
								<div class="feature">
									<img src="wp-content/uploads/2017/09/icon-research-small.png" alt="" class="feature-image">
									<h2 class="feature-title">IOT Platform</h2>
							...
							<div class="col-md-3 col-sm-6">
								<div class="feature">
									<img src="wp-content/uploads/2017/09/icon-medicine-small.png" alt="" class="feature-image">
									<h2 class="feature-title">Smart Building</h2>
									<p>Laborum et dolorum fuga harum quidem rerum facilis et expedita distinctio nam libero tempore.</p>
									<a href="" class="button">Learn more</a>
								</div>
							</div>
							<div class="col-md-3 col-sm-6">
								<div class="feature">
									<img src="wp-content/uploads/2017/09/icon-genetics-small.png" alt="" class="feature-image">
									<h2 class="feature-title">Smart Metring</h2>
									<p>Laborum et dolorum fuga harum quidem rerum facilis et expedita distinctio nam libero tempore.</p>
									<a href="" class="button">Learn more</a>
								</div>
							</div>
							<div class="col-md-3 col-sm-6">
								<div class="feature">
									<img src="wp-content/uploads/2017/09/icon-energy-small.png" alt="" class="feature-image">
									<h2 class="feature-title">Smart Parking</h2>
									<p>Laborum et dolorum fuga harum quidem rerum facilis et expedita distinctio nam libero tempore.</p>
									<a href="" class="button">Learn more</a>
								</div>
							</div>
				...
				<div class="fullwidth-block" data-bg-color="#edf2f4">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="post">
									<figure class="featured-image"><img src="/wp-content/themes/science_lab-6/images/news-1.jpg" alt=""></figure>
							...
							<div class="col-md-4">
								<div class="post">
									<figure class="featured-image"><img src="/wp-content/themes/science_lab-6/images/news-2.jpg" alt=""></figure>
							...
							<div class="col-md-4">
								<div class="post">
									<figure class="featured-image"><img src="/wp-content/themes/science_lab-6/images/news-3.jpg" alt=""></figure>
				...
				<div class="fullwidth-block cta" data-bg-image="/wp-content/themes/science_lab-6/images/cta-bg.jpg">
					<div class="container">
		...
		<script src="\wp-content\themes\science_lab-6\js\jquery-1.11.1.min.js"></script>
		<script src="\wp-content\themes\science_lab-6\js\plugins.js"></script>
		<script src="\wp-content\themes\science_lab-6\js\app.js"></script>
